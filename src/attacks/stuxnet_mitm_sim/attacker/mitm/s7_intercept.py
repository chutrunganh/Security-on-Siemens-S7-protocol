...
VALUE_TO_INJECT = 1200           # Giá trị muốn ép HMI hiển thị
QUEUE_NUM = 1
...
def setup_environment():
    ...
    os.system(f"iptables -t mangle -A FORWARD -p tcp --sport 102 -j NFQUEUE --queue-num {QUEUE_NUM}")
    os.system(f"iptables -t mangle -A FORWARD -p tcp --dport 102 -j NFQUEUE --queue-num {QUEUE_NUM}")
