...
\graphicspath{{figures/}{Figure/}{../figures/}{../docs/Report/}{../attacks/}{../attacks/reconnaissance/}{../attacks/start_stop_plc/}{../attacks/down_up_program/}{../attacks/stuxnet_mitm_sim/}} % Thư mục chứa các hình ảnh
...
\newpage
\chapter{NGUỒN TRAFFIC UPLOAD VÀ DOWNLOAD}
\subfile{Chapter/Appendix_D_Upload_Download}

\newpage
\chapter{TRIỂN KHAI SCRIPT TẤN CÔNG MALFORMED}
