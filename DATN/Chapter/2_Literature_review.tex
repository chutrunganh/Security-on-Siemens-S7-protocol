...
\begin{itemize}
    ...
    Hình~\ref{fig:scada} minh họa ví dụ một hệ thống SCADA.
...
\begin{figure}[H]
    ...
    Hình~\ref{fig:dcs} minh họa ví dụ về một hệ thống DCS triển khai tại một nhà máy.
...
\begin{figure}[H]
    ...
    Hình~\ref{fig:sis} minh họa ví dụ hệ thống SIS.
...
Hình~\ref{fig:plc-components} minh họa các thành phần chính của PLC.
...
Hình~\ref{fig:plc-types} minh họa lOGO! Siemens -- Compact PLC.
...
Hình~\ref{fig:plc-rack} minh họa trong phần mềm lập trình Tia Portal sẽ cần chỉ định rack và slot của module truyền thông của PLC, như ví dụ trong ảnh là rack 0, slot 1 để có thể kết nối tới đúng PLC.
...
Hình~\ref{fig:plc-languages} minh họa năm ngôn ngữ lập trình PLC theo IEC 61131-3.
...
\begin{enumerate}
    ...
    Hình~\ref{fig:ld-example} minh họa ví dụ một chương trình mạch tự duy trì băng ngôn ngữ Ladder.
...
\begin{figure}[H]
    ...
    Hình~\ref{fig:fbd-example} minh họa ví dụ mã FBD.

\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Figure/FBD_code.png}
    ...
    Hình~\ref{fig:sfc-example} minh họa ví dụ mã SFC.

\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Figure/SFC_code.png}
...
Hình~\ref{fig:purdue-overview} minh họa mô hình phân vùng mạng Purdue.
...
Hình~\ref{fig:s7-network-stack} minh họa kiến trúc mạng S7.
...
Hình~\ref{fig:s7-address} minh họa cú pháp địa chỉ trong Siemens S7.
...
Hình~\ref{fig:s7-protocol-stack} minh họa ngăn xếp giao thức S7comm bao gồm 3 thành phần: TPKT, COTP và S7 PDU.
...
Hình~\ref{fig:s7-struct} minh họa cấu trúc một gói tin S7comm.
...
Hình~\ref{fig:s7-header} minh họa cấu trúc S7 Header.
...
\item Gói tin malformed: sai TPKT/COTP, header S7 hoặc tham số Job (Mục~\ref{sec:malformed_plc}, luật \texttt{sid:1000050}--\texttt{1000058})
...
Hình~\ref{fig:s7-connect-flow} minh họa the captured traffic.
...
Hình~\ref{fig:s7-tcp-handshake} minh họa alt text.
...
Hình~\ref{fig:s7-cotp-cr} minh họa alt text.
...
Hình~\ref{fig:s7-setup-comm} minh họa cấu trúc gói tin Setup Communication.
...
\begin{itemize}
    ...
    Hình~\ref{fig:s7-client-server} minh họa các thiết bị bên trái là Client kết nối tới CP bên phải để gửi các S7 Request.
...
\begin{figure}[H]
    ...
    Hình~\ref{fig:s7-cp-arch} minh họa kiến trúc bên trong PLC Server.
...
Hình~\ref{fig:s7-plc-as-client} minh họa pLC đóng vai trò là client.
...
Hình~\ref{fig:s7-partner} minh họa pLC đóng vai trò là partner.
