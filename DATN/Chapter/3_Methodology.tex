...
\begin{enumerate}
    ...
    \item \textbf{Mô phỏng kịch bản tấn công}: thực hiện trinh sát, phát lại lệnh Start/Stop, thao tác upload/download và tấn công man-in-the-middle trên giao thức S7comm.
    ...
    \item \textbf{Xây dựng luật phát hiện}: chuyển các dấu hiệu đã quan sát thành chữ ký Suricata (file \texttt{detect/rules/s7comm.rules}), căn cứ offset byte và mã chức năng S7comm.
...
\subsection{Tấn công DoS trên PLC}
\label{sec:dos_plc}
