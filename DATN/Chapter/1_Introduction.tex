...
Định hướng giải pháp của đồ án là xây dựng môi trường mô phỏng có khả năng tạo ra cả lưu lượng hợp lệ và lưu lượng tấn công. Các kịch bản tấn công được lựa chọn nhằm phản ánh một số nhóm hành vi phổ biến trong quá trình khai thác hệ thống PLC, bao gồm thu thập thông tin, thao tác dữ liệu quá trình, phát lại lệnh điều khiển và can thiệp vào truyền thông. Việc mô phỏng các kịch bản này giúp tạo cơ sở thực nghiệm để quan sát cấu trúc gói tin, xác định dấu hiệu nhận biết và đánh giá khả năng phát hiện.

Sau khi có dữ liệu lưu lượng, đồ án sử dụng hệ thống IDS Suricata để xây dựng các luật phát hiện tương ứng. Các luật này dựa trên đặc điểm của giao thức S7comm và các mã chức năng liên quan đến từng nhóm hành vi. Giải pháp được triển khai theo hướng thụ động, trong đó hệ thống phát hiện chỉ quan sát lưu lượng mạng và sinh cảnh báo khi phát hiện mẫu hành vi phù hợp. Cách tiếp cận này phù hợp với yêu cầu của môi trường công nghiệp do các thiết bị OT thường không nhận được các bản cập nhật, được thi công bởi nhiều nhà thầu từ nhiều quốc gia, việc thay đổi cấu hình hoạt động mang lại rủi ro lớn trong việc tương thích cũng như khả năng khôi phục vận hành.
...
\begin{enumerate}
    ...
    \item Đồ án xây dựng môi trường mô phỏng phục vụ nghiên cứu các hành vi tấn công điển hình trên giao thức S7comm, bao gồm các kịch bản liên quan đến trinh sát, thao tác dữ liệu, phát lại lệnh điều khiển và can thiệp truyền thông.
...
Chương 3 trình bày quá trình xây dựng môi trường mô phỏng và các kịch bản tấn công được sử dụng trong đồ án. Các kịch bản được lựa chọn nhằm thể hiện một số hành vi có rủi ro đối với hệ thống PLC, bao gồm thu thập thông tin, thay đổi dữ liệu quá trình, phát lại lệnh điều khiển và can thiệp vào luồng truyền thông. Thông qua chương này, đồ án làm rõ cách tạo dữ liệu thực nghiệm phục vụ cho việc phân tích và phát hiện.

Chương 4 trình bày phương pháp phát hiện các hành vi tấn công S7comm bằng hệ thống IDS Suricata. Chương này mô tả cách phân tích cấu trúc gói tin, lựa chọn dấu hiệu nhận biết và xây dựng các luật phát hiện tương ứng với từng nhóm hành vi. Bên cạnh đó, chương cũng trình bày kết quả kiểm thử các luật phát hiện trong môi trường mô phỏng.

Chương 5 tổng kết các kết quả đạt được của đồ án, đánh giá những hạn chế còn tồn tại và đề xuất một số hướng phát triển tiếp theo. Các hướng phát triển có thể bao gồm mở rộng tập kịch bản tấn công, kết hợp phát hiện dựa trên hành vi, giảm cảnh báo sai và áp dụng giải pháp trong môi trường mạng công nghiệp có quy mô lớn hơn.
